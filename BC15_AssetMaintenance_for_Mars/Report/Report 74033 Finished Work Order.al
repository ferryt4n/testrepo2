report 74033 "MCH Finished Work Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Report/MCHFinishedWorkOrder.rdlc';
    ...
    dataset
    {
        dataitem(Header;"MCH Work Order Header")
        {
            ...
            RequestFilterHeading = 'Finished Work Order';
            ...
            column(WO_CompletionDateLbl;Txt2Txt(FieldCaption("Completion Date"),false))
            {
            }
            ...
            dataitem(Line;"MCH Work Order Line")
            {
                ...
                column(Line_UsageOnCompletionLbl;Txt2Txt(FieldCaption("Usage on Completion"),false))
                {
                }
            ...
            dataitem(BudgetLine;"MCH Work Order Budget Line")
            {
                ...
                column(Budget_PostedQuantityLbl;Txt2Txt(BudgetPostedQuantityLbl,false))
                {
                }
    ...
    var
        ...
        RequestShowBudgetSumHours: Option No,Budget,"Budget and Actual";
        RequestShowBudgetSumCost: Option No,Budget,"Budget and Actual";
