page 74076 "MCH Maint. Cost Card"
{
    Caption = 'Maintenance Cost Card';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                group(Control1101214030)
                {
                    ...
                    field("Item No.";"Item No.")
                    {
                        ...
                        Importance = Promoted;
                        ShowMandatory = true;
                        ToolTip = 'Specifies the Item that represents the Maint. Cost as a service unit that is not tracked in inventory (Item Type = Service).';
            ...
            group("Purchase & Posting")
            {
                ...
                group("Maint. Cost Specific Values")
                {
                    Caption = 'Maint. Cost Specific Values';
