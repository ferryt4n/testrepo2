page 74159 "MCH Planned Work Orders"
{
    ApplicationArea = Basic,Suite;
    Caption = 'Planned Work Orders';
    CardPageID = "MCH Planned Work Order";
    Editable = false;
    PageType = List;
    ...
    layout
    {
        ...
        area(factboxes)
        {
            part(Control1101214047;"MCH WO Work Descr. FactBC")
            {
                ApplicationArea = Basic,Suite;
            ...
            part(Control1101214003;"MCH Rqst.-Plan. WO Budg. FactB")
            {
                ApplicationArea = Basic,Suite;
                SubPageLink = Status=FIELD(Status),
                              "No."=FIELD("No.");
