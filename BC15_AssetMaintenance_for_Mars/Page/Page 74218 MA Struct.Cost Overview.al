page 74218 "MCH MA Struct.Cost Overview"
{
        ...
        area(content)
        {
            group(Options)
            {
                ...
                field(ValueType;ValueType)
                {
                    ...
                    Importance = Promoted;
                    OptionCaption = 'Rolled-up Cost Amount,Rolled-up Hours,Asset Cost Amount,Asset Hours';
            ...
            part(MatrixSubpage;"MCH MA Struct.Cost Overv. Mtrx")
            {
                ApplicationArea = Basic,Suite;
            }
        }
