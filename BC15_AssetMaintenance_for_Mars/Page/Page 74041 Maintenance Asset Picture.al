page 74041 "MCH Maintenance Asset Picture"
{
    Caption = 'Maintenance Asset Picture';
    Editable = false;
    LinksAllowed = false;
    PageType = CardPart;
    ...
    begin
        Find;
        TestField("No.");
        AMMediaMgt.MaintAssetImportPictureFromFile(Rec);
    end;
    ...
    begin
        ...
        if not Picture.HasValue then
          exit;
        TestField("No.");
        AMMediaMgt.MaintAssetExportPictureToFile(Rec);
    end;
