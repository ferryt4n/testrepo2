page 74060 "MCH Work Order Request"
{
    ...
    layout
    {
        area(content)
        {
            ...
            part(WorkOrderLines;"MCH Work Order Request Sub")
            {
                ApplicationArea = Basic,Suite;
                Caption = 'Lines';
            ...
            part(WorkOrderLineBudget;"MCH WO Rqst.-Plan. Budget Sub")
            {
                ApplicationArea = Basic,Suite;
                Caption = 'Line Budget';
                Editable = false;
        ...
        area(factboxes)
        {
            part(Control1101214005;"MCH Rqst.-Plan. WO Budg. FactB")
            {
                ApplicationArea = Basic,Suite;
                SubPageLink = Status=FIELD(Status),
                              "No."=FIELD("No.");
